...
<body><div class="box"><h1>Set up your business</h1><p>Connect your review link. Shopify and messaging are connected after setup.</p>
...
export default {
  async fetch(request, env) {
    ...
    if (request.method === "POST" && url.pathname === "/api/businesses") {
      ...
      await env.DB.prepare("INSERT INTO businesses(id,name,shop_domain,review_url,plan) VALUES(?,?,?,?,?)")
        .bind(id,b.name,b.shop_domain,b.review_url,b.plan||"starter").run();
